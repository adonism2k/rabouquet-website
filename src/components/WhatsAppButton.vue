<template>
  <a :href="whatsappUrl" target="_blank" rel="noopener noreferrer" :class="buttonClasses">
...
const buttonClasses = computed(() => {
  const base =
    'bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-green-500/50';

  const variants = {
    floating:
      'fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full flex items-center justify-center animate-bounce hover:animate-none',
