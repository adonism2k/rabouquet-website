<template>
  <component :is="href ? 'a' : 'button'" :href="href" :class="buttonClasses" @click="handleClick">
    <slot />
  </component>
</template>
...
const buttonClasses = computed(() => {
  ...
  const variants = {
    primary:
      'bg-gradient-to-r from-pink-500 to-rose-500 text-white hover:from-pink-600 hover:to-rose-600 shadow-lg hover:shadow-pink-500/50',
